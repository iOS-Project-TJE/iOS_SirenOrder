//
//  FindUserPwViewController.swift
//  IOS_SirenOrder
//
...
class FindUserPwViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "sgToChangePw"{
            let checkId = segue.destination as! ResetPassWordViewController
...
extension FindUserPwViewController: QueryEmailProtocol{
